...
namespace DTO
{
    public class ProductDTO
    {
        ...
        public ProductDTO(int id, string name, double purchasePrice, double sellPrice, int quantity, string manufacturer, string storageLocation, string description, bool isDeleted)
        {
            this.id = id;
            this.name = name;
